<template>
  <div v-loading="loading">
    ...
    <elx-editable ref="formList"
      ...
      <elx-editable-column sortable prop="signDate" label="时间(年月日)"></elx-editable-column>
      <elx-editable-column sortable prop="pharmacistname" label="执业药师"></elx-editable-column>
      <elx-editable-column sortable prop="intime" label="上班时间"></elx-editable-column>
      <elx-editable-column sortable prop="outtime" label="下班时间"></elx-editable-column>
     </elx-editable>
    <!--分页-->
...
<script>
  export default {
    ...
    methods : {
      ...
      getFindDocList () {
        this.$api.pharmacists.getPharmacistSignRecord({
